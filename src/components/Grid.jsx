...
const Grid = ({
    ...
    // Level 1 & 2: Always 2x2 for early learners
    // Level 3: 2x2 if <= 4 items, otherwise standard grid
    // NOTE: currentPhase is 0-based (internally), but grid sizing should use conceptual levels
    // FIX: Using simple item count check instead of level-based logic
    const useLargeGrid = items.length <= 4 && currentPhase <= 2;
